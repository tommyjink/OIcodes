...
using namespace std;
const int N=1e6+10;
int n,m,S,P,tot=0,num=0,cnt=0,ans=0;
int dfn[N],low[N],in[N],eval[N],inc[N];
int wine[N],val[N],col[N],head[N],mdis[N];
